...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5263120,
    DYNAMIC_BASE = 5263120,
    DYNAMICTOP_PTR = 20208;
...
function nullFunc_fif(x) { abortFnPtrError(x, 'fif'); }
function nullFunc_fii(x) { abortFnPtrError(x, 'fii'); }
function nullFunc_fiif(x) { abortFnPtrError(x, 'fiif'); }
...
function nullFunc_iiffffi(x) { abortFnPtrError(x, 'iiffffi'); }
...
function nullFunc_viffffi(x) { abortFnPtrError(x, 'viffffi'); }
